...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.configs.controller.cors.withjson;
...
public class PersonControllerCorsJsonTest extends AbstractIntegrationTest{
	...
	public void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("Manoel", persistedPerson.getFirstName());		
		assertEquals("Rabelo", persistedPerson.getLastName());		
		assertEquals("Samanbaia", persistedPerson.getAddress());		
	...
	private void MockPerson() {
		...
		person.setLastName("Rabelo");
		person.setAddress("Samanbaia");
