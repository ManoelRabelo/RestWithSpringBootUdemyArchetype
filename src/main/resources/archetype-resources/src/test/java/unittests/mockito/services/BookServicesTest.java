...
import ${package}.reposirories.BookRepository;
import ${package}.services.BookServices;
import ${package}.unittests.mapper.mocks.MockBook;
...
public class BookServicesTest {
	...
	void testFindById() {
		...
		assertTrue(result.toString().contains("links: [</api/book/v1/1>;rel=${symbol_escape}"self${symbol_escape}"]"));
